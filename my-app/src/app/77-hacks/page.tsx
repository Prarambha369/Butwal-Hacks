  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-4xl px-4 py-14 sm:py-16">
        ...
        />
        <p className="text-xs uppercase tracking-wide text-secondary">Status: Planned / Proposed</p>
        <h1 className="mt-2 text-4xl sm:text-5xl font-bold font-heading tracking-tight text-primary">77 Hacks</h1>
        ...
        <h2 className="mt-10 text-2xl sm:text-3xl font-bold font-heading text-primary">Current Scope</h2>
