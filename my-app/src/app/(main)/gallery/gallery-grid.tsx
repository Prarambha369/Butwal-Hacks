...
import { cloudinaryDownloadUrl, displayPhotoUrl } from "@/lib/cloudinary-url";
        ...
        <div className="relative w-full flex-1 min-h-0 flex items-center gap-2 md:gap-4">
          ...
          <div className="relative flex-1 h-[60vh] md:h-[75vh] rounded-2xl overflow-hidden shadow-2xl bg-black/40">
            {isVideo ? (
              ...
              <Image
                src={displayPhotoUrl(photo.url, photo.optimize, 1600)}
                alt={photo.event}
                fill
        ...
        <div className="p-1">
          <div className="relative w-full aspect-[4/3] overflow-hidden rounded-[14px]">
            {isVideo ? (
              ...
              <Image
                src={displayPhotoUrl(photo.url, photo.optimize, 600)}
                alt={photo.event}
                fill
