      ...
      <div className="sticky top-0 z-50 border-b border-glass bg-background/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            <span className="text-xs text-primary/40 font-mono">Internal</span>
            <Link
              href="/dashboard/maintainer"
              className="rounded-lg border border-glass bg-surface/10 px-4 py-2 text-xs font-bold text-primary/60 hover:text-primary hover:bg-surface/10 transition-all"
            >
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="mb-8 space-y-2">
          ...
          <p className="text-base text-primary/50 max-w-3xl">
            Complete documentation for all 18 internal API endpoints.
            Most endpoints require a valid Supabase session (logged-in user).
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-status-blue/30 bg-status-blue/10 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-status-blue">
              <span className="h-1.5 w-1.5 rounded-full bg-status-blue" />
              15 Auth Required
            </span>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-glass py-6 text-center">
          <p className="text-xs text-primary/30">
            Butwal Hacks Internal API &mdash; For maintainer use only.
            Need help? Contact the maintainer team on GitHub.
          </p>
        </div>
