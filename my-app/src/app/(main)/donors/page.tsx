  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:py-16">
            ...
            <CardContent className="p-6 sm:p-8">
              <div className="grid gap-6 lg:grid-cols-3">
                ...
                <div className="flex flex-col justify-center gap-3">
                  <div className="rounded-lg border border-glass bg-surface p-4 text-center">
                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          ...
                          <span className="text-xs text-secondary">{donor.date}</span>
                        </div>
                      </div>
          ...
          <div className="mt-10">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {goldDonors.map((donor, idx) => (
                <Card key={idx} className="border border-status-yellow/30 bg-gradient-to-br from-card to-status-yellow/5">
        ...
        <div className="mt-16">
          ...
          <div className="mt-8 columns-1 gap-4 sm:columns-2 lg:columns-3">
            {communitySupport.map((supporter, idx) => (
              <Card key={idx} className="mb-4 break-inside-avoid border-glass">
        ...
        {/* Call to Action */}
        <div className="mt-16 rounded-xl border border-glass bg-surface p-8 text-center">
