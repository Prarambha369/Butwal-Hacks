  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <section className="mx-auto max-w-3xl px-4 py-14 sm:py-16">
        ...
        <p className="text-xs uppercase tracking-[0.18em] text-secondary">Butwal Hacks Foundation</p>
        <h1 className="mt-4 text-5xl font-bold font-heading leading-[0.95] tracking-tight text-primary sm:text-6xl md:text-7xl">
          Philosophy
        </h1>

        <article className="mt-12 space-y-12">
          <section>
            <h2 className="text-3xl font-bold font-heading leading-tight text-primary sm:text-4xl">
