    ...
    <main className="min-h-dvh bg-background text-primary">
      ...
      <section className="border-b border-border px-4 py-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-4 flex flex-wrap gap-5 text-sm text-secondary">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 xl:grid-cols-[260px_1fr_260px]">
          ...
          <article className="min-w-0">
            ...
            <div className="mt-7 flex flex-wrap items-center justify-between gap-3 border-t border-border pt-5">
              ...
              <p className="text-sm text-secondary">Last updated: Feb 23, 2026</p>
            </div>
          ...
          <aside className="space-y-4 xl:sticky xl:top-24 xl:h-fit">
            <div className="rounded-xl border border-border bg-surface p-4">
              ...
              <nav className="mt-3 space-y-2">
                {toc.map((item) => (
                  <a key={item.id} href={`#${item.id}`} className="block text-sm text-secondary hover:text-primary">
                    {item.label}
                  </a>
                ))}
              </nav>
