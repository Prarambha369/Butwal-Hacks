...
// ponytail: no cmdk/kbar deps. useEffect keyboard listener + useState controls.
        ...
        <div className="bh-card overflow-hidden border border-border/50 shadow-2xl">
          ...
          <div className="flex items-center justify-between border-t border-border/30 px-5 py-3">
            <div className="flex items-center gap-3 text-[10px] text-muted-foreground/50">
              <span><kbd className="rounded border border-border/30 px-1 font-mono">↑↓</kbd> {t("search.kbd_navigate", locale)}</span>
              <span><kbd className="rounded border border-border/30 px-1 font-mono">↵</kbd> {t("search.kbd_open", locale)}</span>
