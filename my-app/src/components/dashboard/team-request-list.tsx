...
export default function TeamRequestList({ teamId, onUpdate }: TeamRequestListProps) {
  ...
  return (
    <div className="space-y-4 p-6 rounded-3xl bg-surface/10 border border-glass">
      ...
      <div className="space-y-3">
        {requests.map(req => (
          <div key={req.id} className="flex items-center justify-between p-3 rounded-2xl bg-background border border-glass">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] font-mono text-secondary">{req.profiles?.bh_id}</p>
              </div>
            </div>
