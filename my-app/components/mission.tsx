    ...
    <section id="mission" className="px-4 py-16 sm:py-20 border-y border-border bg-background">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <section id="what-we-do" aria-labelledby="core-pillars" className="scroll-mt-28">
                ...
                return (
                  <Card key={pillar.title} className={`border hover:shadow-lg transition-all ${colorClass}`}>
                    <CardHeader className="flex-row items-start justify-between space-y-0">
                      <CardTitle className="text-base sm:text-lg font-heading text-foreground leading-snug">{pillar.title}</CardTitle>
          ...
          <section id="roadmap" aria-labelledby="roadmap-heading" className="scroll-mt-28">
            <header className="mb-6">
